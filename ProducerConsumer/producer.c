...
void InitShm(int bufSize, int itemCnt)
{
    int in = 0;
    int out = 0;	
    const char *name = "OS_HW1_ChristianSolano"; // Name of shared memory object to be passed to shm_open
    ...
    gShmPtr = mmap(0,4096, PROT_WRITE | PROT_READ, MAP_SHARED, shm_fd,0);
